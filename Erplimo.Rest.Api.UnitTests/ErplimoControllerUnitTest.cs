...
using Erplimo.Model.DataModels;
using Erplimo.Model.Models.Criteria;
using Erplimo.Model.Models.Request;
using Erplimo.Model.Models.Response;
using Erplimo.Rest.Api.Controllers;
using Erplimo.Rest.Api.Mapper;
using Microsoft.AspNetCore.Mvc;
using Xunit;

namespace Erplimo.Rest.Api.UnitTests
{
    public class ErplimoControllerUnitTest
    {
        ...
        private ErplimoController InitialFlyPlanController(string action)
        {
            ...
            var controller = new ErplimoController(null, _dbContext, mapper);
            return controller;
        }
    }
}
