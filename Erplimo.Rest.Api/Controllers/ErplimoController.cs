...
namespace Erplimo.Rest.Api.Controllers
{
    [Route("api")]
    [ApiController]
    public class ErplimoController : ControllerBase
    {
        protected readonly ILogger Logger;
        protected readonly FlyplanContext DbContext;
        protected readonly IMapper Mapper;

        public ErplimoController(ILogger<ErplimoController> logger, FlyplanContext dbContext, IMapper mapper)
        {
            Logger = logger;
            DbContext = dbContext;
            Mapper = mapper;
        ...
        private IActionResult ValidationData(FulfillBookingRequest fulfillOrderRequest)
        {
            ...
            {
                //foreach (PropertyInfo property in fulfillOrderRequest.ConfirmationInfoViewModel.GetProperties())
                //{
